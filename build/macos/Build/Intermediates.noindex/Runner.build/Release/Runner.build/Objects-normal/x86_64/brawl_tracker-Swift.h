...
#ifndef BRAWL_TRACKER_SWIFT_H
#define BRAWL_TRACKER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="brawl_tracker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13brawl_tracker11AppDelegate")
...
SWIFT_CLASS("_TtC13brawl_tracker17MainFlutterWindow")
